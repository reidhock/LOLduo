...
//		System.out.println("Summoners Name:::::::::" + summName);
		...
		//서머너의 최근 전적 객체
		MatchHistory matchHistory = MatchHistory.forSummoner(summoner2).get();
...
//
//		final MatchHistory allmatchHistory = MatchHistory.forSummoner(summoner).withQueues(Queue.RANKED_SOLO).withSeasons(Season.SEASON_9).get(); //솔랭을 전제로 함
...
//        for(final Match match : allmatchHistory) {
...
//        }
//        System.out.println("Length of match history: " + allmatchHistory.size()); // 해당 시즌 총 게임판수를 긁어온다. 
//        
